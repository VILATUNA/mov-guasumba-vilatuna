...
public class ListItemPoligasExpressBindingImpl extends ListItemPoligasExpressBinding implements com.example.poli_gas.generated.callback.OnClickListener.Listener {
    ...
    public ListItemPoligasExpressBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private ListItemPoligasExpressBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback1 = new com.example.poli_gas.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.poligas == variableId) {
            ...
            setClickListener((com.example.poli_gas.expressorder.PoliGasListener) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setClickListener(@Nullable com.example.poli_gas.expressorder.PoliGasListener ClickListener) {
    ...
    protected void executeBindings() {
        ...
        com.example.poli_gas.expressorder.PoliGasListener clickListener = mClickListener;
