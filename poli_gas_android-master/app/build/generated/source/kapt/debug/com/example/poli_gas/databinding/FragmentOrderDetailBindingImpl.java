...
public class FragmentOrderDetailBindingImpl extends FragmentOrderDetailBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.orderDetail == variableId) {
            setOrderDetail((com.example.poli_gas.detailorder.OrderDetailFragment) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setOrderDetail(@Nullable com.example.poli_gas.detailorder.OrderDetailFragment OrderDetail) {
